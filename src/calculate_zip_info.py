...
def create_zip_file():
    ...
    # 要包含的文件和目录
    include_items = ['apps', 'docs', 'spfapps', 'README.md', 'btcfg.py', 'current_slot', 'fs.py', 'kernel.py', 'logk.py', 'main.py', 'ota.py', 'parse_spf.py', 'printk.py', 'pyspos.py', 'recovery.py', 'sync.py', 'version.txt', 'launcher.py', 'start.bat', 'start.sh']
...
if __name__ == "__main__":
    raise RuntimeError("这个文件已经弃用了，但是我不会删除它，我是念旧的人")
else:
    raise SystemExit("这个文件已经弃用了，但是我不会删除它，我是念旧的人")